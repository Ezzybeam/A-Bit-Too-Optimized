 ...
 * shows, via VideoSettingsScreenInvoker) and turns each into its own vanilla widget.
 * This reuses Minecraft's controls rather than reimplementing them, so they stay
 * correct and adapt across versions.
 */
public final class VanillaVideoRows {
    ...
    /** Build the vanilla control widget for one option at the given position and width. */
    public static AbstractWidget makeWidget(OptionInstance<?> option, Options options, int x, int y, int width) {
